...
type CustomColorPickerProps = {
  ...
  setColor: (color: returnedResults) => void;
};

export default function CustomColorPicker({ onSelectColor, setColor }: CustomColorPickerProps) {
  ...
  return (
    <View style={{ justifyContent: 'center', alignItems: 'center', padding: 10 }}>
      <Pressable style={styles.openButton} onPress={() => setShowModal(true)}>
        <Text style={{ color: '#707070', fontWeight: 'bold', textAlign: 'center' }}>Selecione a cor da conta</Text>
      </Pressable>
      ...
      <View style={{
        backgroundColor: selectedColor ? selectedColor.value : "#FFF",
        margin: 5,
        width: '80%',
        height: 5,
        borderRadius: 5,
